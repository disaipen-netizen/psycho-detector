...
- Обычный флирт, шутки, лёгкое общение = токсичность 0-25%
- Небольшая закрытость, уклончивость = 25-40%
- Реальные манипуляции, обесценивание = 40-70%  
- Явный газлайтинг, абьюз = 70-100%
- НЕ натягивай манипуляции на нейтральные фразы
- Если переписка здоровая — честно скажи об этом в summary
