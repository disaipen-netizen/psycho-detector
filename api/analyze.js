...
module.exports = async function handler(req, res) {
  ...
  let { text, image, images, imageTypes, audio, audios, audioTypes, analyzeTarget } = req.body || {};
      ...
      userContent = [
        ...
        })),
        {
          ...
          text: images.length > 1
            ...
            : `Прочитай переписку на скриншоте. ${analyzeMe ? "Анализируй автора переписки — того кто прислал эти скриншоты (обычно правая сторона / другой цвет). Представь что анализируешь КАК ВЫГЛЯДИТ пользователь в глазах собеседника." : "Анализируй ТОЛЬКО собеседника — человека с которым общается пользователь (обычно левая сторона). НЕ анализируй и НЕ цитируй сообщения пользователя (правая сторона)."} Проведи полный психологический анализ.`,
        },
      ];
    } else {
